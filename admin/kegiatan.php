...
<body>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <button class="btn btn-info btn-xs" id="btn_persetujuan">Persetujuan</button>&nbsp
                                <button class="btn btn-danger btn-xs" id="btn_batal">Batalkan persetujuan</button>
                                <a href="tambahkegiatan.php" class="btn btn-primary btn-xs"><span class="fa fa-plus-square"></span> Buat Baru</a>
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
           $('#btn_persetujuan').click(function() {
                var select_kodekegiatan=[];
                $('td input[type=checkbox]').each(function(){
                    if ($(this).is(":checked")) {
                        select_kodekegiatan.push($(this).attr('value'));
                        persetujuan(this.value);
                    }
                });
    ...
    <script type="text/javascript">
        function persetujuan(val){
            $.ajax({
                type:"POST",
                url:"persetujuan.php?data=kegiatan",
                data:"kode_kegiatan="+val,
        ...
        function batal(val){
            $.ajax({
                type:"POST",
                url:"persetujuan.php?data=batalkan",
                data:"kode_kegiatan="+val,
                success:function(data){
                    $("#table").html(data);
                    table.ajax.reload();
