<?php
    ...
    if(isset($_POST['kirim'])){
        ...
        $query= mysqli_query($conn,"INSERT INTO tbl_agent VALUES('$code_agent','$nama_depan','$nama_belakang','$jenis_kelamin','$tempat_lahir','$tgl_lahir','$pekerjaan','$alamat','$provinsi','$kabupaten','$kecamatan','$telp','$email','','$lokasi','$code_user')");
