<?php
    include('../koneksi.php');
    $id=$_GET['id'];
    $query = mysqli_query($conn,"SELECT * FROM tbl_peserta AS a inner join tbl_sekolah AS b on a.kode_sekolah = b.kode_sekolah where kode_peserta = '$id' ");
                        ...
                        <div class="ibox-content">
                            <form method="get" class="form-horizontal">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Jenis Kelamin</label>
                                    <div class="col-sm-10">
                                        <div class="radio-inline i-checks"><label> <input type="radio" value="" name="a" <?php if($row['jenis_kelamin']=='perempuan'){echo "checked";} ?> /> Perempuan </label></div>
                                        <div class="radio-inline i-checks"><label> <input type="radio" value="" name="a" <?php if($row['jenis_kelamin']=='laki-laki'){echo "checked";} ?> /> Laki-laki </label></div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <a href="peserta.php" class="btn btn-white" style="width:100px;">Close</a>
                                    </div>
                                </div>                         
                            </form>
                        </div>
