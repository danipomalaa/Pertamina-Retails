<?php
    include('../koneksi.php');
    $id=$_GET['id'];
    $query = mysqli_query($conn,"SELECT * FROM tbl_agent where '$id'=kode_agent");
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="save.php">
                                ...
                                <div class="col-sm-12"><input type="text" style="display:none" class="form-control" value="<?php echo $row['kode_agent'] ?>" name="kode_agent"/></div>
                                </div>
                                ...
                                <div class="form-group" id="data_1"><label class="col-sm-2 control-label">Tempat tanggal lahir</label>
                                    <div class="col-sm-4"><input type="text" class="form-control" value="<?php echo $row['tempat_lahir'] ?>" name="tempat_lahir" /></div>
                                    <div class="col-sm-6">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Alamat</label>
                                    <div class="col-sm-10"><textarea class="form-control" rows="2" cols="12" name="alamat"><?php echo $row['alamat'] ?></textarea></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">No.Telepon</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" data-mask="(999) 999-9999" value="<?php echo $row['telp'] ?>" name="telp" /></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Email</label>
                                    <div class="col-sm-10"><input type="email" class="form-control" value="<?php echo $row['email'] ?>" name="email" /></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">Pekerjaan</label>
                                    <div class="col-sm-10"><input type="text" class="form-control" value="<?php echo $row['pekerjaan'] ?>" name="pekerjaan" /></div>
                                </div>
                                <br />  
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="agent.php" class="btn btn-white" style="width:100px;">Close</a>
                                    </div>
                                </div>                         
                            </form>
                        </div>
