                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" action="simpan_kegiatan.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" value="<?php echo $lokasi['nama_lokasi'] ?>" disabled />
                                        <input type="text" class="form-control" value="<?php echo $kode_lokasi ?>" name="lokasi" style="display: none;"/>
                                    </div>
                                </div>
                                <div class="form-group">
