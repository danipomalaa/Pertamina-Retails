    ...
    ?>
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-lg-10">
                ...
                <ol class="breadcrumb">
                    <li>
                        <a href="agent.php?kode=<?php echo $kode_lokasi ?>">Home</a>
                    </li>
                    <li class="active">
                        <strong>Tambah Agent</strong>
                    </li>
                </ol>
            </div>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <h3>PROFILE</h3>
                            <div class="jumbotron" style="background-color:#ebe0e3;">
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Lokasi *</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="kode_lokasi" class="form-control" value="<?php echo $kode_lokasi ?>" style="display:none" >
                                        <input type="text" name="lokasi" class="form-control" value="<?php echo $lokasi['nama_lokasi'] ?>" disabled>
                                    </div>
                                </div>
                            </div>
                        <h3>User Account</h3>
                        <div class="jumbotron" style="background-color:#e2e9e9;">
                            ...
                            <a href="agent.php?kode=<?php echo $kode_lokasi ?>" class="btn btn-white" style="width:100px;">Cancel</a>
                        </form> 
                        </div>
                    </div>
                </div>
