<?php
    ...
    $query = mysqli_query($conn,"SELECT * FROM tbl_agent where kode_agent = '$id'");
                            ...
                            <form method="post" class="form-horizontal" action="save.php">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="agent.php?kode=<?php echo $row['kode_lokasi'] ?>" class="btn btn-white" style="width:100px;">Close</a>
                                    </div>
                                </div>                         
                            </form>
                        </div>
