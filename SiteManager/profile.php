<?php
    ...
    $query = mysqli_query($conn,"SELECT * FROM tbl_sitemanager AS a inner join tbl_user AS b on a.user_id = b.user_id WHERE a.user_id = '$id'");
    ...
    if(isset($_POST['simpan'])){
        ...
        if ($_FILES['image']['name'] == "") {
            $query = mysqli_query($conn,"UPDATE tbl_sitemanager set nama_depan='$nama_depan', nama_belakang='$nama_belakang', jenis_kelamin='$jenis_kelamin', tempat_lahir='$tempat_lahir', tgl_lahir='$tgl_lahir', telp='$telp', pekerjaan='$pekerjaan', alamat='$alamat', email='$email' where kode_manager='$kode' "); 
        }
        if ($_FILES['image']['name'] != "") {
            $query = mysqli_query($conn,"UPDATE tbl_sitemanager set foto ='$image', nama_depan='$nama_depan', nama_belakang='$nama_belakang', jenis_kelamin='$jenis_kelamin', tempat_lahir='$tempat_lahir', tgl_lahir='$tgl_lahir', telp='$telp', pekerjaan='$pekerjaan', alamat='$alamat', email='$email' where kode_manager='$kode' ");
        }
                        ...
                        <div class="ibox-content">
                            <form method="post" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="form-group" id="data_1"><label class="col-sm-2 control-label">Tempat tanggal lahir</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group date">
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span><input type="text" class="form-control" name="tgl_lahir" value="<?php echo $row['tgl_lahir'] ?>" required/>
                                        </div>
                                    </div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                <div class="form-group"><label class="col-sm-2 control-label">No.Telepon</label>
                                    <div class="col-sm-10"><input name="telp" type="text" class="form-control" data-mask="(999) 999-9999" value="<?php echo $row['telp'] ?>" /></div>
                                </div>
                                <div class="hr-line-dashed"></div>
                                ...
                                <div class="form-group"><label class="col-sm-2 control-label">Foto</label>
                                    <div class="col-sm-10">
                                        <?php echo "<img alt='image' width='150px' src='images/".$row['foto']."'>"?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <a href="dashboard.php?kode=<?php echo $row['kode_lokasi'] ?>" class="btn btn-white" style="width:100px;">Cancel</a>
                                    </div>
                                </div>                         
                            </form>
                        </div>
