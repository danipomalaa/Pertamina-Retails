<?php
    ...
    $query = mysqli_query($conn,"SELECT * FROM tbl_agent as a inner join tbl_lokasi as b on a.kode_lokasi = b.kode_lokasi where a.kode_lokasi='$kode_lokasi'");
?>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a href="Addagent.php?kode=<?php echo $kode_lokasi ?>" class="btn btn-primary btn-xs"><span class="fa fa-plus-square"> </span> Tambah Agent</a>
                            </div>
                        </div>
                        <div class="ibox-content">
                            ...
                            <input type="text" name="kode_lokasi" value="<?php echo $kode_lokasi ?>" id="kode" style="display:none;">
                                ...
                                <tbody>
                                    <?php $i = 0;
                                      while ($row = mysqli_fetch_array($query)) {
                                        ...
                                        echo "<td>".
                                            "<div class='btn-group'>
                                                <a href='profilAgent.php?id=".$row['kode_agent']."&kode=".$kode_lokasi."' class='btn btn-white btn-xs width=60px'>View</a>
    ...
    <script type="text/javascript">
        function search(){
            ...
            $.ajax({
                ...
                data:"search_name="+search_name+"&kode="+kode,
