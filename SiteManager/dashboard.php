...
<head>
    ...
    <script type="text/javascript">
        function getdata(){
            ...
            $.ajax({
                type:"POST",
                url:"../admin/data_dashboard.php?data=sitemanager",
                data:"pilih="+pilih+"&kode="+kode,
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-success pull-right"><?php echo $lokasi['nama_lokasi'] ?></span>
                            <h5>Agent</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">
                                <?php
                                    $query_agent = mysqli_query($conn, "SELECT * FROM tbl_agent where kode_lokasi = '$kode_lokasi' ");
                ...
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-primary pull-right"><?php echo $lokasi['nama_lokasi'] ?></span>
                            <h5>Peserta</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">
                                <?php
                                    $query_peserta = mysqli_query($conn, "SELECT * FROM tbl_peserta where kode_lokasi='$kode_lokasi' ");
                ...
                <div class="col-lg-3">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <span class="label label-info pull-right"><?php echo $lokasi['nama_lokasi'] ?></span>
                            <h5>Kegiatan</h5>
                        </div>
                        <div class="ibox-content">
                            <h1 class="no-margins">
                                <?php
                                    $query_kegiatan = mysqli_query($conn, "SELECT * FROM tbl_kegiatan where kode_lokasi = '$kode_lokasi' ");
                                ...
                                <div class="col-lg-3">
                                    <ul class="stat-list">
                                        ...
                                        <li>
                                            <h2 class="no-margins">
                                                <?php
                                                    $query1 = mysqli_query($conn, "SELECT * FROM tbl_peserta WHERE kode_lokasi='$kode_lokasi' AND YEAR(tgl_daftar) = YEAR(CURRENT_DATE - INTERVAL 1 MONTH) AND MONTH(tgl_daftar) = MONTH(CURRENT_DATE - INTERVAL 1 MONTH)");
                                        ...
                                        <li>
                                            <h2 class="no-margins ">
                                                <?php
                                                    $query2 = mysqli_query($conn, "SELECT * FROM tbl_peserta WHERE kode_lokasi='$kode_lokasi' AND YEAR(tgl_daftar) = YEAR(CURRENT_DATE - INTERVAL 2 MONTH) AND MONTH(tgl_daftar) = MONTH(CURRENT_DATE - INTERVAL 2 MONTH)");
                                            ...
                                            <div class="stat-percent"><?php echo $bar2 ?> % <i class="fa fa-level-down text-navy"></i></div>
                                            <div class="progress progress-mini">
                                        ...
                                        <li>
                                            <h2 class="no-margins ">
                                                <?php
                                                    $query3 = mysqli_query($conn, "SELECT * FROM tbl_peserta WHERE kode_lokasi='$kode_lokasi' AND YEAR(tgl_daftar) = YEAR(CURRENT_DATE - INTERVAL 3 MONTH) AND MONTH(tgl_daftar) = MONTH(CURRENT_DATE - INTERVAL 3 MONTH)");
                                            ...
                                            <div class="stat-percent"><?php echo $bar3 ?> % <i class="fa fa-bolt text-navy"></i></div>
                                            <div class="progress progress-mini">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                            $i = 0;
                                            $query2 = mysqli_query($conn, "SELECT b.nama_lokasi,a.status, a.tgl_mulai, a.tgl_selesai, a.target_peserta FROM tbl_kegiatan AS a inner join tbl_lokasi AS b on a.kode_lokasi = b.kode_lokasi where a.kode_lokasi='$kode_lokasi'");
                                            while($row2=mysqli_fetch_array($query2)) {
                                                $i++;
                                                echo "<tr>";
                                                echo "<td>".$i."</td>";
                                                echo "<td>".$row2['nama_lokasi']."</td>";
                                                echo "<td>";
                                                echo "<div class='col-sm-6'>".$row2['tgl_mulai']."</div>";
                                                echo "<div class='col-sm-6'>".$row2['tgl_selesai']."</div>";
                                                echo "</td>";
                                                echo "<td>".$row2['target_peserta']."</td>";
                                                echo "<td>";
