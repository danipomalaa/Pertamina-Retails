<?php
    include 'koneksi.php';
    $id = $_GET['id'];
    $query_sekolah = mysqli_query($conn,"SELECT * FROM tbl_sekolah where kode_lokasi = '$id' ");
    ...
    $query_lokasi = mysqli_query($conn,"SELECT * FROM tbl_lokasi where kode_lokasi = '$id' ");
...
<div id="wrapper">
    <div class="gray-bg" style="min-height: 1199px;">
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                <li>
                    <a href="halaman_daftar.php">Home</a>
                </li>
                <li class="active">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form method="POST" class="form-horizontal" action="pendaftaran.php" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select name="kode_agent" class="form-control">
                                    <option value="0">Pilih Agent</option>
                                    <?php
                                        $query_agent = mysqli_query($conn,"SELECT * FROM tbl_agent where kode_lokasi = '$id' ");
                                        foreach ($query_agent as $agent) {
                                            echo "<option value='".$agent['kode_agent']."'>".$agent['nama_depan'].' '.$agent['nama_belakang']."</option>";
                                        }
                                    ?>
                                </select>
                            </div>
                    ...
                    <h3>Data Dokumen</h3>
                        <div class="jumbotron" style="background-color:#e8e3e3;">
                            ...
                            <a href="halaman_daftar.php" class="btn btn-white" style="width:100px;">Cancel</a>
                    </form> 
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-sm-12"><h3 class="m-t-none m-b">Tambah Sekolah</h3>
                            <form role="form" action="tambah_sekolah.php" method="post">
                                ...
                                <div>
                                    ...
                                    <?php echo "<a href='daftar.php?id=".$id."' class='btn btn-sm btn-white pull-right m-t-n-xs'>" ?>Cancel</a>
                                </div>
                            </form>
                        </div>
                    </div>
